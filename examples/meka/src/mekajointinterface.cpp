...
//! constructor
MekaJointInterface::MekaJointInterface(std::string _input_scope, std::string control_scope, std::string _output_scope)
   : humotion::server::JointInterface() {
...
void MekaJointInterface::execute_motion() {
	if (controller_enabled) {
		...
		// printf("targets pan=%4.1f tilt=%4.1f (eye p %4.1f t
